...
function badge_shift_enqueue_styles() {
    ...
    $z_index = get_option( 'badge_shift_z_index', '999' ); // Default z-index value
    $hide_badge = get_option( 'badge_shift_hide_badge' );
    ...
    $custom_css = "
        .grecaptcha-badge {
            ...
            visibility: " . ( $hide_badge ? 'hidden' : 'visible' ) . " !important;
        }
    ";
...
function badge_shift_register_settings() {
    ...
    register_setting( 'badge_shift_settings_group', 'badge_shift_hide_badge' );
}
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
				...
				<tr valign="top">
                    ...
                    <td><input type="checkbox" name="badge_shift_hide_badge" <?php checked( get_option( 'badge_shift_hide_badge' ), 'on' ); ?> /></td>
                </tr>
            </table>
            <?php submit_button(); ?>
        </form>
